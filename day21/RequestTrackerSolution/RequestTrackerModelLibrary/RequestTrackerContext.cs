...
namespace RequestTrackerModelLibrary
{
    public class RequestTrackerContext:DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-A92QBO1\DEMO;Integrated Security=true;Initial Catalog=dbEmployeeTrackerCF;");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Employee>().HasData(
                ...
                new Employee { Id = 104, Name = "Bimu", Password = "bimu123", Role = "User" },
                new Employee { Id = 105, Name = "Bimu", Password = "bimu123", Role = "User" }
                );
